...
document.getElementsByTagName("header")[0].innerHTML =  '<h1 style="margin-bottom: 0; padding-bottom: 0;">Roan Contreras</h1>\n<p style="text-align: center;">' + (docTitle.length == 1 ? '<a href="games.html">Games</a> / <a href="experiments.html">Experiments</a>  / roan.contreras [@] hotmail.com' : docTitle[1].trim() + " / " + '<a href="index.html">Home</a>') + "</p>";
